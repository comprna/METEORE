...
We provide an example dataset `data/example` for you to try with. The example contains 40 single-read fast5 files which are from the positive control dataset for E.coli generated by Simpson et al. (2017).
